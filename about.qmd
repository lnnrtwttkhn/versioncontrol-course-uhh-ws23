...
#     - icon: globe
#       text: Website
#       href: https://lennartwittkuhn.com/
#       aria-label: Website
#     - icon: github
#       text: GitHub
#       href: https://github.com/lnnrtwttkhn
#       aria-label: GitHub
#     - icon: twitter
#       text: Twitter
#       href: https://twitter.com/lnnrtwttkhn
#       aria-label: Twitter
#     - icon: google
#       text: Scholar
#       href: https://scholar.google.de/citations?user=GXvJB1kAAAAJ&hl=en
#       aria-label: Google Scholar
#     - icon: mastodon
#       text: Mastodon
#       href: https://fediscience.org/users/lnnrtwttkhn
#       aria-label: Mastodon
#     - icon: linkedin
#       text: LinkedIn
#       href: https://www.linkedin.com/in/dr-lennart-wittkuhn-6a079a1a8/
#       aria-label: linkedin
---
